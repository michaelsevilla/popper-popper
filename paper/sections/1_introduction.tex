...
% double blinded; in fact, we should expose reviewer names to further communication
% clear definition of reproducibility, replicability, and open source
% multiple revision rounds
% reducing the shame of quick experimental results
...
% moving away from quick money grabs; follow the open source model to write good code
% single repository hubs per organization; no password protections!
